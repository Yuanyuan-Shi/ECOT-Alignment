...
name="$1"
output="round4-move-eval-${name}-90task-2trial-seed20261201"
python -u experiments/robot/libero/run_libero_eval.py \
  --model_family prismatic \
  --pretrained_checkpoint "runs/ecot-move-alignment/round4-lambda05-restart-${name}/checkpoints/step-000200-move-lora.pt" \
