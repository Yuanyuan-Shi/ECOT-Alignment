...
python -u experiments/robot/libero/run_libero_eval.py \
  ...
  --pretrained_checkpoint "runs/ecot-move-alignment/round3-ecot-lite-libero90-hinge-lora-r16-lambda${suffix}-seed20261102/checkpoints/step-000500-move-lora.pt" \
