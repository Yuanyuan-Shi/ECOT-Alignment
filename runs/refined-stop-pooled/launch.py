...
Q=ROOT/'runs/refined-stop-pooled';PY='/home/exx/.conda/envs/openvla/bin/python'
...
for key in ['pretrained','lambda1','moveonly']:
    state['runs'][key]={'evaluation_root':f'experiments/robot/libero/results/refined-stop-pooled-fast-{key}-30task-3trial-seed20261211','evaluation_status':'pending'}
    if key!='pretrained':state['runs'][key].update(run_dir=f'runs/ecot-move-alignment/refined-stop-pooled-lr5e5-{key}-seed20261102',training_status='queued')
